# Getting help with imaggar

Thanks for using imaggar. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/imaggar/issues) to make sure the 
